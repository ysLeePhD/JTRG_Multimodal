...
data21$modality_commutes <- ifelse(data21$commute_total>0, "Other multimodals", data21$modality_commutes) 
data21$modality_commutes <- ifelse(data21$pct_commute_car==100, "Only car user", data21$modality_commutes) 
data21$modality_commutes <- ifelse(data21$pct_commute_car>=75 & data21$pct_commute_car<100, "Mostly car user", data21$modality_commutes) 
data21$modality_commutes <- ifelse(data21$pct_commute_transit==100, "Only transit rider", data21$modality_commutes) 
data21$modality_commutes <- ifelse(data21$pct_commute_transit>=50 & data21$pct_commute_transit<100, "Mostly transit rider", data21$modality_commutes) 
...
data21$modality_commutes <- factor(data21$modality_commutes, 
                                   levels=c("Only car user", "Mostly car user", 
